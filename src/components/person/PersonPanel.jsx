...
import { X, ChevronDown, ChevronUp, Focus, Pencil, Users, UserPlus } from 'lucide-react'
                  ...
                  <ol className="space-y-4">
                    {educationEntries.map((entry, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="absolute -left-1.25 top-1.5 h-2 w-2 rounded-full bg-indigo-400" />
